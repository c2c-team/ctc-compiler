...
namespace antlrcpp
{
    ...
    class ANTLR4CPP_PUBLIC Utf8 final
    {
      public:
        ...
        // strictDecode(), each byte in an illegal byte sequence is replaced with the Unicode
        ...
        // each invalid Unicode code point is replaced with the Unicode replacement character,
        // U+FFFD.
