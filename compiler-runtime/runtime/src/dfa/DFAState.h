    ...
    namespace dfa
    {
        ...
        class ANTLR4CPP_PUBLIC DFAState final
        {
          public:
            ...
            ///  <seealso cref="#requiresFullContext"/> is {@code false} since full context
            ///  prediction evaluates predicates on-the-fly. If this is not null, then <seealso
            ///  cref="#prediction"/> is <seealso cref="ATN#INVALID_ALT_NUMBER"/>.
            /// <p/>
            ///  We only use these for non-<seealso cref="#requiresFullContext"/> but conflicting
            ///  states. That means we know from the context (it's $ or we don't dip into outer
