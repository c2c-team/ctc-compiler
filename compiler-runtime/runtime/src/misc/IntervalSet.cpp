...
ssize_t IntervalSet::getSingleElement() const
{
    ...
    return Token::INVALID_TYPE; // XXX: this value is 0, but 0 is a valid interval range, how can
                                // that work?
}
...
void IntervalSet::remove(ssize_t el)
{
    for (size_t i = 0; i < _intervals.size(); ++i)
    {
        ...
        { // found in this interval
            ...
            break; // ml: not in the Java code but I believe we also should stop searching here, as
                   // we found x.
        }
    }
}
