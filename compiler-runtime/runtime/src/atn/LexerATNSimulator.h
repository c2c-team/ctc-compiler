    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC LexerATNSimulator : public ATNSimulator
        {
          ...
          protected:
            ...
            ///  via <seealso cref="IntStream#mark"/> and record the current state. The current sim
            ///  state includes the current index into the input, the current line, and current
            ///  character position in that line. Note that the Lexer is tracking the starting line
            ///  and characterization of the token. These variables track the "state" of the
            ///  simulator when it hits an accept state.
            /// <p/>
          ...
          protected:
            ...
            virtual Ref<LexerATNConfig> getEpsilonTarget(CharStream *input,
            ...
            /// simulator to the original state before returning (i.e. undo the actions made by the
            ...
            /// {@code true}. </returns>
            virtual bool evaluatePredicate(CharStream *input, size_t ruleIndex, size_t predIndex,
                                           bool speculative);
