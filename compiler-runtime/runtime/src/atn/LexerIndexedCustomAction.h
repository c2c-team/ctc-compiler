    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC LexerIndexedCustomAction final : public LexerAction
        {
          public:
            ...
            /// </summary>
            /// <param name="offset"> The offset into the input <seealso cref="CharStream"/>,
            /// relative to the token start index, at which the specified lexer action should be
            /// executed. </param>
            ...
            /// </returns>
            const Ref<const LexerAction> &getAction() const
            {
                return _action;
            }
