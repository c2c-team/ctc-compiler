    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC LexerPushModeAction final : public LexerAction
        {
          public:
            ...
            /// <param name="mode"> The mode value to pass to <seealso cref="Lexer#pushMode"/>.
            /// </param>
            ...
            /// {@inheritDoc}
            ///
            /// <para>This action is implemented by calling <seealso cref="Lexer#pushMode"/> with
            /// the value provided by <seealso cref="#getMode"/>.</para>
            /// </summary>
