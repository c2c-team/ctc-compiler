    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC LexerChannelAction final : public LexerAction
        {
          public:
            ...
            /// <param name="channel"> The channel value to pass to <seealso
            ...
            /// {@inheritDoc}
            ///
            /// <para>This action is implemented by calling <seealso cref="Lexer#setChannel"/> with
            /// the value provided by <seealso cref="#getChannel"/>.</para>
            /// </summary>
