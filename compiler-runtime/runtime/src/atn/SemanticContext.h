    ...
    namespace atn
    {
            ...
            : public std::enable_shared_from_this<SemanticContext>
        {
          public:
            ...
            SemanticContextType getContextType() const
            {
                return _contextType;
            }
             ...
             * </ul>
             */
            virtual Ref<const SemanticContext> evalPrecedence(Recognizer *parser,
        ...
        class ANTLR4CPP_PUBLIC SemanticContext::PrecedencePredicate final : public SemanticContext
        {
          public:
            ...
            bool eval(Recognizer *parser, RuleContext *parserCallStack) const override;
            Ref<const SemanticContext> evalPrecedence(Recognizer *parser,
