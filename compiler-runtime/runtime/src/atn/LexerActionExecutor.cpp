...
Ref<const LexerActionExecutor> LexerActionExecutor::append(
    const Ref<const LexerActionExecutor> &lexerActionExecutor, Ref<const LexerAction> lexerAction)
{
    ...
    lexerActions.insert(lexerActions.begin(), lexerActionExecutor->_lexerActions.begin(),
...
bool LexerActionExecutor::equals(const LexerActionExecutor &other) const
{
    ...
    return cachedHashCodeEqual(_hashCode.load(std::memory_order_relaxed),
           ...
           std::equal(_lexerActions.begin(), _lexerActions.end(), other._lexerActions.begin(),
                      lexerActionEqual);
}
