    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC ParserATNSimulator : public ATNSimulator
        {
          ...
          protected:
            ...
            virtual ATNConfigSet *removeAllConfigsNotInRuleStopState(ATNConfigSet *configs,
                                                                     bool lookToEndOfRule);

            virtual std::unique_ptr<ATNConfigSet> computeStartState(ATNState *p, RuleContext *ctx,
                                                                    bool fullCtx);
            ...
            virtual std::vector<Ref<const SemanticContext>> getPredsForAmbigAlts(
            ...
            /// on {@code to} </returns>
            virtual dfa::DFAState *addDFAEdge(dfa::DFA &dfa, dfa::DFAState *from, ssize_t t,
                                              dfa::DFAState *to);
