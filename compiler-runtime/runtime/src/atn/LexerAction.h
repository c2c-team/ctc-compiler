    ...
    namespace atn
    {
        ...
        class ANTLR4CPP_PUBLIC LexerAction
        {
          public:
            ...
            ///
            /// IMPORTANT: Unlike Java, this returns LexerActionType::INDEXED_CUSTOM for instances
            /// of LexerIndexedCustomAction. If you need the wrapped action type, use
            /// LexerIndexedCustomAction::getAction()->getActionType().
            LexerActionType getActionType() const
            {
                return _actionType;
            }
