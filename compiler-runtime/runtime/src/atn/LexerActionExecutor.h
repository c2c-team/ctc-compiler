...
namespace antlr4
{
    namespace atn
    {
            ...
            : public std::enable_shared_from_this<LexerActionExecutor>
        {
          public:
            /// <summary>
            /// Constructs an executor for a sequence of <seealso cref="LexerAction"/> actions.
            /// </summary> <param name="lexerActions"> The lexer actions to execute. </param>
            ...
            static Ref<const LexerActionExecutor> append(
            ...
            /// <seealso cref="IntStream#seek"/> on the input <seealso cref="CharStream"/> to set
            /// the input position to the <em>end</em> of the current token. This behavior provides
