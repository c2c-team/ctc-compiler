...
namespace antlr4
{
    ...
    class ANTLR4CPP_PUBLIC Parser : public Recognizer
    {
      public:
        ...
        /// matches, <seealso cref="ANTLRErrorStrategy#reportMatch"/> and <seealso cref="#consume"/>
        ...
        /// <returns> {@code true} if the <seealso cref="ParserRuleContext#children"/> list is
        /// trimmed using the default <seealso cref="Parser.TrimToSizeListener"/> during the parse
        /// process. </returns>
        ...
        /// </pre>
        /// </summary>
        virtual tree::pattern::ParseTreePattern compileParseTreePattern(const std::string &pattern,
        ...
        virtual void notifyErrorListeners(Token *offendingToken, const std::string &msg,
                                          std::exception_ptr e);
         ...
         */
        virtual void pushNewRecursionContext(ParserRuleContext *localctx, size_t state,
                                             size_t ruleIndex);
