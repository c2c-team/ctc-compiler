...
void ProxyErrorListener::reportAmbiguity(Parser *recognizer, const dfa::DFA &dfa, size_t startIndex,
                                         ...
                                         atn::ATNConfigSet *configs)
{
    for (auto *listener : _delegates)
    {
        listener->reportAmbiguity(recognizer, dfa, startIndex, stopIndex, exact, ambigAlts,
                                  configs);
    }
}

void ProxyErrorListener::reportAttemptingFullContext(Parser *recognizer, const dfa::DFA &dfa,
...
void ProxyErrorListener::reportContextSensitivity(Parser *recognizer, const dfa::DFA &dfa,
                                                  size_t startIndex, size_t stopIndex,
