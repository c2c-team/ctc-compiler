    ...
    namespace tree
    {
        ...
        class ANTLR4CPP_PUBLIC AbstractParseTreeVisitor : public ParseTreeVisitor
        {
          ...
          protected:
            ...
            /// a whole.
            /// </summary>
            /// <param name="node"> The <seealso cref="ParseTree"/> whose children are currently
            /// being visited. </param> <param name="currentResult"> The current aggregate result of
            /// the children visited to the current point.
            /// </param>
