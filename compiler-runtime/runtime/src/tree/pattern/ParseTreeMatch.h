        ...
        namespace pattern
        {
            ...
            class ANTLR4CPP_PUBLIC ParseTreeMatch
            {
              ...
              public:
                ...
                /// process. </param> <param name="mismatchedNode"> The first node which failed to
                /// match the tree pattern during the matching process.
                /// </param>
                /// <exception cref="IllegalArgumentException"> if {@code tree} is {@code null}
                /// </exception> <exception cref="IllegalArgumentException"> if {@code pattern} is
                /// {@code null} </exception> <exception cref="IllegalArgumentException"> if {@code
                /// labels} is {@code null} </exception>
                ...
                /// </param>
                /// <returns> A collection of all <seealso cref="ParseTree"/> nodes matching tags
                /// with the specified {@code label}. If no nodes matched the label, an empty list
                /// is returned. </returns>
