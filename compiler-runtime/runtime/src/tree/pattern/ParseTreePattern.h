        ...
        namespace pattern
        {
            ...
            class ANTLR4CPP_PUBLIC ParseTreePattern
            {
              public:
                ...
                /// created this tree pattern. </param> <param name="pattern"> The tree pattern in
                /// concrete syntax form. </param> <param name="patternRuleIndex"> The parser rule
                /// which serves as the root of the tree pattern. </param> <param
                /// name="patternTree"> The tree pattern in <seealso cref="ParseTree"/> form.
                /// </param>
                ...
                /// <summary>
                /// Get the tree pattern as a <seealso cref="ParseTree"/>. The rule and token tags
                /// from the pattern are present in the parse tree as terminal nodes with a symbol
