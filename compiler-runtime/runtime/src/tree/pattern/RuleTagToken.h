    ...
    namespace tree
    {
        namespace pattern
        {
            ...
            class ANTLR4CPP_PUBLIC RuleTagToken : public Token
            {
              ...
              public:
                /// <summary>
                /// Constructs a new instance of <seealso cref="RuleTagToken"/> with the specified
                /// rule name and bypass token type and no label.
                /// </summary>
                /// <param name="ruleName"> The name of the parser rule this rule tag matches.
                /// </param> <param name="bypassTokenType"> The bypass token type assigned to the
                /// parser rule.
                /// </param>
                ...
                /// <summary>
                /// Constructs a new instance of <seealso cref="RuleTagToken"/> with the specified
                /// rule name, bypass token type, and label.
                /// </summary>
                /// <param name="ruleName"> The name of the parser rule this rule tag matches.
                /// </param> <param name="bypassTokenType"> The bypass token type assigned to the
                /// parser rule. </param> <param name="label"> The label associated with the rule
                /// tag, or {@code null} if the rule tag is unlabeled.
                /// </param>
                /// <exception cref="IllegalArgumentException"> if {@code ruleName} is {@code null}
                /// or empty. </exception>
                ...
                /// The implementation for <seealso cref="RuleTagToken"/> always returns {@code
                /// null}.
                ...
                /// The implementation for <seealso cref="RuleTagToken"/> returns a string of the
                /// form {@code ruleName:bypassTokenType}.
