...
namespace antlr4
{
    namespace tree
    {
        namespace pattern
        {
            ...
            /// {@code <ID>}. These tokens are created for <seealso cref="TagChunk"/> chunks where
            /// the tag corresponds to a lexer rule or token type.
            /// </summary>
            class ANTLR4CPP_PUBLIC TokenTagToken : public CommonToken
            {
              ...
              private:
                ...
                /// <summary>
                /// Constructs a new instance of <seealso cref="TokenTagToken"/> for an unlabeled
                /// tag with the specified token name and type.
                /// </summary>
              ...
              public:
                ...
                /// {@inheritDoc}
                /// <p/>
                /// The implementation for <seealso cref="TokenTagToken"/> returns a string of the
                /// form
                /// {@code tokenName:type}.
                /// </summary>
