...
namespace antlr4
{
    namespace tree
    {
        ...
        ///
        /// The payload is either a <seealso cref="Token"/> or a <seealso cref="RuleContext"/>
        /// object.
        ...
        class ANTLR4CPP_PUBLIC ParseTree
        {
          public:
            ...
            // ml: memory is not managed here, but by the owning class. This is just for the
            // structure.
            ...
            // ml: This has been changed to use Any instead of a template parameter, to avoid the
            // need of a virtual template function.
            ...
            ParseTreeType getTreeType() const
            {
                return _treeType;
            }
