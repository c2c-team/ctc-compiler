...
static const std::string_view help_message =
        ...
        "\n\t-std [--STD-VERSION--] - replacing language version by default. Possibly values: stable(current version of language). For example: -stdstable"
        "\n\t-o | --out - specify output for object file"
        "\n\t-emit-llvm - the translation is interrupted after the LLVM IR is generated, and the LLVM IR will dump to file"
