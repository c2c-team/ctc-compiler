...
public:
  ...
  enum {
    ...
    RuleInitializerList = 137, RuleBracedInitList = 138, RuleInterfaceHead = 139, 
    RuleInterfaceSpecifier = 140, RuleInterfacefunctionDefinition = 141, 
    RuleInterfaceMemberSpecification = 142, RuleRecordKey = 143, RuleRecordHead = 144, 
    RuleRecordSpecifier = 145, RuleRecordMemberSpecification = 146, RuleRecordMemberDeclaratorList = 147, 
    RuleClassName = 148, RuleClassSpecifier = 149, RuleClassHead = 150, 
    RuleClassHeadName = 151, RuleClassVirtSpecifier = 152, RuleClassKey = 153, 
    RuleMemberSpecification = 154, RuleMemberdeclaration = 155, RuleMemberDeclaratorList = 156, 
    RuleMemberDeclarator = 157, RuleVirtualSpecifierSeq = 158, RuleVirtualSpecifier = 159, 
    RulePureSpecifier = 160, RuleBaseClause = 161, RuleBaseSpecifierList = 162, 
    RuleBaseSpecifier = 163, RuleClassOrDeclType = 164, RuleBaseTypeSpecifier = 165, 
    RuleAccessSpecifier = 166, RuleConversionFunctionId = 167, RuleConversionTypeId = 168, 
    RuleConversionDeclarator = 169, RuleConstructorInitializer = 170, RuleMemInitializerList = 171, 
    RuleMemInitializer = 172, RuleMeminitializerid = 173, RuleOperatorFunctionId = 174, 
    RuleLiteralOperatorId = 175, RuleTemplateDeclaration = 176, RuleTemplateparameterList = 177, 
    RuleTemplateParameter = 178, RuleTypeParameter = 179, RuleSimpleTemplateId = 180, 
    RuleTemplateId = 181, RuleTemplateName = 182, RuleTemplateArgumentList = 183, 
    RuleTemplateArgument = 184, RuleTypeNameSpecifier = 185, RuleExplicitInstantiation = 186, 
    RuleExplicitSpecialization = 187, RuleTryBlock = 188, RuleFunctionTryBlock = 189, 
    RuleHandlerSeq = 190, RuleHandler = 191, RuleExceptionDeclaration = 192, 
    RuleThrowExpression = 193, RuleExceptionSpecification = 194, RuleDynamicExceptionSpecification = 195, 
    RuleTypeIdList = 196, RuleNoeExceptSpecification = 197, RuleTheOperator = 198, 
    RuleLiteral = 199
  };
