...
class CtcLangParser : public antlr4::Parser
{
  public:
    ...
    enum
    {
        ...
        RulePrimaryExpression = 1,
        RuleIdExpression = 2,
        RuleUnqualifiedId = 3,
        RuleQualifiedId = 4,
        RuleNestedNameSpecifier = 5,
        RuleLambdaExpression = 6,
        RuleLambdaIntroducer = 7,
        RuleLambdaCapture = 8,
        RuleCaptureDefault = 9,
        RuleCaptureList = 10,
        RuleCapture = 11,
        RuleSimpleCapture = 12,
        RuleInitcapture = 13,
        RuleLambdaDeclarator = 14,
        RulePostfixExpression = 15,
        RuleTypeIdOfTheTypeId = 16,
        RuleExpressionList = 17,
        RulePseudoDestructorName = 18,
        RuleUnaryExpression = 19,
        RuleUnaryOperator = 20,
        RuleNewExpression_ = 21,
        RuleNewPlacement = 22,
        RuleNewTypeId = 23,
        RuleNewDeclarator_ = 24,
        RuleNoPointerNewDeclarator = 25,
        RuleNewInitializer_ = 26,
        RuleDeleteExpression = 27,
        RuleNoExceptExpression = 28,
        RuleCastExpression = 29,
        RulePointerMemberExpression = 30,
        RuleMultiplicativeExpression = 31,
        RuleAdditiveExpression = 32,
        RuleShiftExpression = 33,
        RuleShiftOperator = 34,
        RuleRelationalExpression = 35,
        RuleEqualityExpression = 36,
        RuleAndExpression = 37,
        RuleExclusiveOrExpression = 38,
        RuleInclusiveOrExpression = 39,
        RuleLogicalAndExpression = 40,
        RuleLogicalOrExpression = 41,
        RuleConditionalExpression = 42,
        RuleAssignmentExpression = 43,
        RuleAssignmentOperator = 44,
        RuleExpression = 45,
        RuleConstantExpression = 46,
        RuleStatement = 47,
        RuleLabeledStatement = 48,
        RuleExpressionStatement = 49,
        RuleCompoundStatement = 50,
        RuleStatementSeq = 51,
        RuleSelectionStatement = 52,
        RuleCondition = 53,
        RuleIterationStatement = 54,
        RuleForInitStatement = 55,
        RuleForRangeDeclaration = 56,
        RuleForRangeInitializer = 57,
        RuleJumpStatement = 58,
        RuleDeclarationStatement = 59,
        RuleDeclarationseq = 60,
        RuleDeclaration = 61,
        RuleBlockDeclaration = 62,
        RuleAliasDeclaration = 63,
        RuleSimpleDeclaration = 64,
        RuleStaticAssertDeclaration = 65,
        RuleEmptyDeclaration_ = 66,
        RuleAttributeDeclaration = 67,
        RuleDeclSpecifier = 68,
        RuleDeclSpecifierSeq = 69,
        RuleStorageClassSpecifier = 70,
        RuleFunctionSpecifier = 71,
        RuleTypedefName = 72,
        RuleTypeSpecifier = 73,
        RuleTrailingTypeSpecifier = 74,
        RuleTypeSpecifierSeq = 75,
        RuleTrailingTypeSpecifierSeq = 76,
        RuleSimpleTypeLengthModifier = 77,
        RuleSimpleTypeSignednessModifier = 78,
        RuleSimpleTypeSpecifier = 79,
        RuleTheTypeName = 80,
        RuleDecltypeSpecifier = 81,
        RuleElaboratedTypeSpecifier = 82,
        RuleEnumName = 83,
        RuleEnumSpecifier = 84,
        RuleEnumHead = 85,
        RuleOpaqueEnumDeclaration = 86,
        RuleEnumkey = 87,
        RuleEnumbase = 88,
        RuleEnumeratorList = 89,
        RuleEnumeratorDefinition = 90,
        RuleEnumerator = 91,
        RuleNamespaceName = 92,
        RuleOriginalNamespaceName = 93,
        RuleNamespaceDefinition = 94,
        RuleNamespaceAlias = 95,
        RuleNamespaceAliasDefinition = 96,
        RuleQualifiednamespacespecifier = 97,
        RuleUsingDeclaration = 98,
        RuleUsingDirective = 99,
        RuleAsmDefinition = 100,
        RuleLinkageSpecification = 101,
        RuleAttributeSpecifierSeq = 102,
        RuleAttributeSpecifier = 103,
        RuleAlignmentspecifier = 104,
        RuleAttributeList = 105,
        RuleAttribute = 106,
        RuleAttributeNamespace = 107,
        RuleAttributeArgumentClause = 108,
        RuleBalancedTokenSeq = 109,
        RuleBalancedtoken = 110,
        RuleInitDeclaratorList = 111,
        RuleInitDeclarator = 112,
        RuleDeclarator = 113,
        RulePointerDeclarator = 114,
        RuleNoPointerDeclarator = 115,
        RuleParametersAndQualifiers = 116,
        RuleTrailingReturnType = 117,
        RulePointerOperator = 118,
        RuleCvqualifierseq = 119,
        RuleCvQualifier = 120,
        RuleRefqualifier = 121,
        RuleDeclaratorid = 122,
        RuleTheTypeId = 123,
        RuleAbstractDeclarator = 124,
        RulePointerAbstractDeclarator = 125,
        RuleNoPointerAbstractDeclarator = 126,
        RuleAbstractPackDeclarator = 127,
        RuleNoPointerAbstractPackDeclarator = 128,
        RuleParameterDeclarationClause = 129,
        RuleParameterDeclarationList = 130,
        RuleParameterDeclaration = 131,
        RuleFunctionDefinition = 132,
        RuleFunctionBody = 133,
        RuleInitializer = 134,
        RuleBraceOrEqualInitializer = 135,
        RuleInitializerClause = 136,
        RuleInitializerList = 137,
        RuleBracedInitList = 138,
        RuleInterfaceHead = 139,
        RuleInterfaceSpecifier = 140,
        RuleInterfacefunctionDefinition = 141,
        RuleInterfaceMemberSpecification = 142,
        RuleRecordKey = 143,
        RuleRecordHead = 144,
        RuleRecordSpecifier = 145,
        RuleRecordMemberSpecification = 146,
        RuleRecordMemberDeclaratorList = 147,
        RuleClassName = 148,
        RuleClassSpecifier = 149,
        RuleClassHead = 150,
        RuleClassHeadName = 151,
        RuleClassVirtSpecifier = 152,
        RuleClassKey = 153,
        RuleMemberSpecification = 154,
        RuleMemberdeclaration = 155,
        RuleMemberDeclaratorList = 156,
        RuleMemberDeclarator = 157,
        RuleVirtualSpecifierSeq = 158,
        RuleVirtualSpecifier = 159,
        RulePureSpecifier = 160,
        RuleBaseClause = 161,
        RuleBaseSpecifierList = 162,
        RuleBaseSpecifier = 163,
        RuleClassOrDeclType = 164,
        RuleBaseTypeSpecifier = 165,
        RuleAccessSpecifier = 166,
        RuleConversionFunctionId = 167,
        RuleConversionTypeId = 168,
        RuleConversionDeclarator = 169,
        RuleConstructorInitializer = 170,
        RuleMemInitializerList = 171,
        RuleMemInitializer = 172,
        RuleMeminitializerid = 173,
        RuleOperatorFunctionId = 174,
        RuleLiteralOperatorId = 175,
        RuleTemplateDeclaration = 176,
        RuleTemplateparameterList = 177,
        RuleTemplateParameter = 178,
        RuleTypeParameter = 179,
        RuleSimpleTemplateId = 180,
        RuleTemplateId = 181,
        RuleTemplateName = 182,
        RuleTemplateArgumentList = 183,
        RuleTemplateArgument = 184,
        RuleTypeNameSpecifier = 185,
        RuleExplicitInstantiation = 186,
        RuleExplicitSpecialization = 187,
        RuleTryBlock = 188,
        RuleFunctionTryBlock = 189,
        RuleHandlerSeq = 190,
        RuleHandler = 191,
        RuleExceptionDeclaration = 192,
        RuleThrowExpression = 193,
        RuleExceptionSpecification = 194,
        RuleDynamicExceptionSpecification = 195,
        RuleTypeIdList = 196,
        RuleNoeExceptSpecification = 197,
        RuleTheOperator = 198,
        RuleLiteral = 199
    };
    ...
    CtcLangParser(antlr4::TokenStream *input,
    ...
    {
      public:
        SimpleTypeSignednessModifierContext(antlr4::ParserRuleContext *parent,
    ...
    {
      public:
        NoPointerAbstractPackDeclaratorContext(antlr4::ParserRuleContext *parent,
                                               size_t invokingState);
        virtual size_t getRuleIndex() const override;
        antlr4::tree::TerminalNode *Ellipsis();
        NoPointerAbstractPackDeclaratorContext *noPointerAbstractPackDeclarator();
    ...
    {
      public:
        DynamicExceptionSpecificationContext(antlr4::ParserRuleContext *parent,
                                             size_t invokingState);
        virtual size_t getRuleIndex() const override;
        antlr4::tree::TerminalNode *Throw();
        antlr4::tree::TerminalNode *LeftParen();
    ...
    bool noPointerNewDeclaratorSempred(NoPointerNewDeclaratorContext *_localctx,
                                       size_t predicateIndex);
    bool noPointerDeclaratorSempred(NoPointerDeclaratorContext *_localctx, size_t predicateIndex);
    bool noPointerAbstractDeclaratorSempred(NoPointerAbstractDeclaratorContext *_localctx,
                                            size_t predicateIndex);
    bool noPointerAbstractPackDeclaratorSempred(NoPointerAbstractPackDeclaratorContext *_localctx,
                                                size_t predicateIndex);
